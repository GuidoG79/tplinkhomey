...
// get driver name based on dirname (lb120, kl120, etc.)
...
class TPlinkBulbDevice extends Homey.Device {
    ...
    async onInit() {
        ...
        let circadianModeOn = this.homey.getActionCard('circadianModeOn');

        let circadianModeOff = this.homey.getActionCard('circadianModeOff');

        let transitionOn = this.homey.getActionCard('transitionOn');

        let transitionOff = this.homey.getActionCard('transitionOff');

        /*
        let meterResetAction = this.homey.getActionCard('meter_reset');
 

        let undoMeterResetAction = this.homey.getActionCard('undo_meter_reset');
        */
